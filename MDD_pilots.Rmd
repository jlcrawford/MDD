...
output:
  ...
  code_folding: "hide"
---
#Cross-Domain Discounting Project (18 YAs)
...
p.2 <- ggplot(average.SV, aes(Speech, WM)) +
   theme(plot.title = element_text(hjust = 0.5), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.line = element_line(colour = "black")) +
  geom_point() + geom_smooth(method=lm) +ggtitle("Within-Subject Correlation Across WM & Speech Domains")
p.2
