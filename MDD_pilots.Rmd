...
#Packages
library(BayesFactor); library(brms); library(knitr); library(kableExtra); library(RColorBrewer); library(tidyverse);
source("summarySEwithin2.R")

#Package versions used for these analyses
## BayesFactor_0.9.12-4.2; brms_2.12.0; knitr_1.25; kableExtra_1.1.0; RColorBrewer_1.1-2; tidyverse_1.3.0; R version 3.5.2
