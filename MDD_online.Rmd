...
### Correlation between averaged residuals from models controlling for the effects of task level & performance (removing outliers)
...
### Partial correlation controlling for WMC and reward sensitivity (from residualized SV estimates; removing outliers)
